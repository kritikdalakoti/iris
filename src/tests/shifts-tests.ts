...
// import {shiftsFailurePayload,shiftsUpdatePayload,shiftsSuccessPayload} from '../tests/payloads/shifts-payloads'
...
// describe('unit tests - shift-details Get all Entry For companyId', () => {
...
//   // path check
//   describe('unit tests - shifts Api Path Check', () => {
...
// describe('unit tests - shifts Create Entry', () => {
...
//     for (i = 0; i < shiftsFailurePayload.length; i++) {

//         let payload = shiftsFailurePayload[i];
...
// describe('unit tests - shifts Get All Entry', () => {
...
//         _id = reponse['result']['list'][0]['shiftId']
//         expect(reponse['statusCode']).to.equal(200);
//         expect(reponse['isSuccess']).to.equal(true);
//         expect(typeof reponse['result']).to.equal('object')
//         expect(typeof (reponse['result'])).to.equal('object')
...
// describe('unit tests - shifts Get Single Entry', () => {
...
// //Update Entry
// describe('unit tests - shifts Update Entry', () => {
...
//     //    console.log("resssult",reponse['result'][0]['shiftId']);

//         let id = reponse['result'][0]["shiftId"];
//         console.log(id);
//         expect(reponse['statusCode']).to.equal(200);
//         expect(reponse['isSuccess']).to.equal(true);
//         expect(typeof (reponse['result'])).to.equal('object')
...
// describe('unit tests - shifts Delete Entry', () => {
